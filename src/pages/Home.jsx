...
function Hero({ selectedCategory, onSelectCategory }) {
  return (
    <section className="relative overflow-hidden bg-white py-20 lg:py-28">
      ...
      <div className="section-shell relative grid gap-12 lg:grid-cols-2 lg:items-center">
        ...
        <div className="relative" style={{ width: '100%' }}>
          <KrabiMap selectedCategory={selectedCategory} onSelectCategory={onSelectCategory} />
        </div>
      </div>
    </section>
  );
...
function Home({ selectedCategory, onSelectCategory }) {
  return (
    <main>
      <Hero selectedCategory={selectedCategory} onSelectCategory={onSelectCategory} />
      <ExperienceGrid />
      <FleetSection />
      <Footer />
    </main>
